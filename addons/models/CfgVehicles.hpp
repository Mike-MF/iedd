class CfgVehicles {
    ...
    class IEDD_WireStraightRed: IEDD_WireStraight_Base {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(textures\IED_WireRed_co.paa)};
    };
    ...
    class IEDD_WireStraightYellow: IEDD_WireStraightRed {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(textures\IED_WireYellow_co.paa)};
    };
    ...
    class IEDD_WireStraightGreen: IEDD_WireStraightRed {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(textures\IED_WireGreen_co.paa)};
    };
    ...
    class IEDD_WireStraightBlue: IEDD_WireStraightRed {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(textures\IED_WireBlue_co.paa)};
    };
    ...
    class IEDD_WireStraightBlack: IEDD_WireStraightRed {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(textures\IED_WireBlack_co.paa)};
    };
